...
- [ ] **CHAT-01**: Code blocks use Shiki v4 with VS Code Dark+ theme for syntax highlighting — 99% VS Code token parity
- [ ] **CHAT-02**: Code blocks display language label in header, copy-to-clipboard button with success state feedback
- [ ] **CHAT-03**: Completed AI turns are collapsible — first line of response text + count badge (e.g., "I'll fix the auth... [+12 tool calls]"), click to expand full turn
