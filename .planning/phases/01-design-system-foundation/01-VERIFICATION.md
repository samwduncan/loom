...
|----------|----------|--------|---------|
| `src-v2/src/styles/tokens.css` | All design tokens as CSS custom properties on :root, min 80 lines, contains oklch | VERIFIED | 144 lines, 29 oklch tokens, single :root block, zero hex/HSL |
| `src-v2/src/lib/motion.ts` | Spring physics constants, exports SPRING_GENTLE/SNAPPY/BOUNCY, EASING, DURATION | VERIFIED | 55 lines, all 5 exports present with correct values |
| `src-v2/src/styles/index.css` | Tailwind v4 entry with @theme inline semantic mapping | VERIFIED | 66 lines, @import "tailwindcss", @theme and @theme inline blocks |
| `src-v2/src/styles/base.css` | @font-face for all 3 font families with font-display: swap | VERIFIED | 56 lines, 4 @font-face blocks, all with font-display: swap |
| `src-v2/src/components/dev/TokenPreview.tsx` | Comprehensive token preview page, min 200 lines | VERIFIED | 851 lines, 8 sections, interactive demos |
| `src-v2/src/utils/cn.ts` | clsx + tailwind-merge className utility | VERIFIED | 6 lines, exports cn function |
| `src-v2/vite.config.ts` | Vite config with React, Tailwind v4, proxy, @ alias | VERIFIED | 33 lines, react + tailwindcss plugins, proxy to :5555, @ alias |
| `src-v2/eslint.config.js` | ESLint flat config with no-default-exports | VERIFIED | 41 lines, Constitution 2.2 enforcement active |
| `src-v2/public/fonts/*.woff2` | 4 self-hosted font files | VERIFIED | 4 files present |

### Key Link Verification

| From | To | Via | Status | Details |
|------|----|-----|--------|---------|
| src-v2/src/main.tsx | src-v2/src/styles/index.css | CSS import | WIRED | `import '@/styles/index.css'` on line 3 |
| src-v2/src/styles/index.css | src-v2/src/styles/base.css | @import | WIRED | `@import "./base.css"` on line 3 |
| src-v2/src/styles/index.css | src-v2/src/styles/tokens.css | @import | WIRED | `@import "./tokens.css"` on line 2 |
| src-v2/vite.config.ts | @tailwindcss/vite | plugin import | WIRED | `tailwindcss()` in plugins array |
...
| src-v2/src/App.tsx | TokenPreview.tsx | React Router /dev/tokens | WIRED | `<Route path="/dev/tokens" element={<TokenPreview />} />` with named import |
