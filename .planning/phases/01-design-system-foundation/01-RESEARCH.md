...
- **Source directory:** Fresh directory separate from V1 src/ (e.g., src-v2/ or clean branch)
...
3. **V2 source directory approach**
   - What we know: CONTEXT.md says "fresh directory separate from V1 src/". Options: `src-v2/`, clean branch, or scaffold in project root.
