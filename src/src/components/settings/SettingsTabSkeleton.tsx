  ...
  return (
    <div className="space-y-6 p-1" data-testid="settings-tab-skeleton">
      ...
      <div className="space-y-3">
        <div className="h-5 w-32 animate-pulse rounded-md bg-surface-raised" />
      ...
      <div className="space-y-3">
        ...
        <div className="h-10 w-1/2 animate-pulse rounded-md bg-surface-raised" />
      </div>

      {/* Simulated toggle row */}
      <div className="flex items-center justify-between">
        <div className="h-5 w-40 animate-pulse rounded-md bg-surface-raised" />
        <div className="h-6 w-10 animate-pulse rounded-full bg-surface-raised" />
      </div>

      {/* Simulated section header + field */}
      <div className="space-y-3">
        <div className="h-5 w-28 animate-pulse rounded-md bg-surface-raised" />
        <div className="h-10 w-full animate-pulse rounded-md bg-surface-raised" />
      </div>
    </div>
  );
