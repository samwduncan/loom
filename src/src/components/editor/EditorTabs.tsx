        ...
        {openTabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <button
                type="button"
                className="ml-1 p-0.5 rounded-sm hover:bg-[var(--surface-overlay)] transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
