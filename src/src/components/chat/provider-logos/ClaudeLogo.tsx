/**
 * ClaudeLogo -- Official Anthropic Claude logomark (sparkle/starburst).
 * Source: https://claude.ai/favicon.svg (Bootstrap Icons normalized 16x16)
 * Supports animated prop for streaming state — gentle pulse + glow.
...
export function ClaudeLogo({ className, animated }: ClaudeLogoProps) {
  return (
    <svg
      className={cn(
        className,
        animated && 'animate-claude-pulse',
      )}
      viewBox="0 0 16 16"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
      style={animated ? { filter: 'drop-shadow(0 0 3px var(--logo-claude))' } : undefined}
    >
      <path
