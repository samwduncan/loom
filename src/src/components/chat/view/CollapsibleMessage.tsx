    ...
    return (
      <div data-testid="collapsible-wrapper">
        <button
          ...
          className="flex w-full items-center gap-2 rounded px-2 py-1 text-xs text-muted transition-colors hover:bg-surface-raised focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
