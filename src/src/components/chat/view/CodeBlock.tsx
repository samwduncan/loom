    ...
    >
      ...
      <div className="flex justify-between items-center px-3 py-1.5 border-b border-border-subtle">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs text-muted hover:text-secondary transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 rounded-sm min-h-[44px] md:min-h-0 px-2 md:px-0"
        >
          {copied ? (
            <>
              <Check size={14} />
