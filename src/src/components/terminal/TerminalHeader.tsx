  ...
  return (
    <div className="flex h-10 items-center gap-2 border-b border-border/8 bg-[var(--surface-raised)] px-3">
      ...
      <button
        ...
        className="rounded p-1 text-[var(--text-muted)] transition-colors hover:bg-surface-overlay hover:text-[var(--text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
      >
