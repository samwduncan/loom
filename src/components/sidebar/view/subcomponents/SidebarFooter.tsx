      ...
      {updateAvailable && (
        <>
          ...
          <div className="hidden md:block px-2 py-1.5">
            <button
              className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-left hover:bg-blue-50/80 hover:bg-blue-900/15 transition-colors group"
              onClick={onShowVersionModal}
            >
              <div className="relative flex-shrink-0">
                <ArrowUpCircle className="w-4 h-4 text-blue-500 text-blue-400" />
                <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse" />
              </div>
              <div className="min-w-0 flex-1">
                <span className="text-sm font-medium text-blue-600 text-blue-300 truncate block">
          ...
          <div className="md:hidden px-3 py-2">
            <button
              className="w-full h-11 bg-blue-50/80 bg-blue-900/15 border border-blue-200/60 border-blue-700/40 rounded-xl flex items-center gap-3 px-3.5 active:scale-[0.98] transition-all"
              onClick={onShowVersionModal}
            >
              <div className="relative flex-shrink-0">
