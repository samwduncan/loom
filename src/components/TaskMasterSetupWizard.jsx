          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900 text-white">Options</h4>
                ...
                <label className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm text-gray-700 text-gray-300">Initialize Git repository</span>
                </label>
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-700 text-gray-300">Store tasks in Git</span>
                </label>
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-700 text-gray-300">Add shell aliases (tm, taskmaster)</span>
                </label>
              </div>
                  ...
                  {['claude', 'cursor', 'vscode', 'roo', 'cline', 'windsurf'].map(rule => (
                    <label key={rule} className="flex items-center gap-2">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                      />
                      <span className="text-sm text-gray-700 text-gray-300 capitalize">{rule}</span>
                    </label>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 bg-blue-950 border border-blue-200 border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-blue-600 text-blue-400 mt-0.5" />
                <div>
                  ...
                  <div className="bg-white bg-gray-800 rounded border p-3 mb-3">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-mono text-gray-600 text-gray-400">.mcp.json</span>
                      <button
                        onClick={copyMCPConfig}
                        className="flex items-center gap-1 px-2 py-1 text-xs bg-gray-100 bg-gray-700 text-gray-600 text-gray-300 rounded hover:bg-gray-200 hover:bg-gray-600 transition-colors"
                      >
                        <Copy className="w-3 h-3" />
                        Copy
                      </button>
                    </div>
                    <pre className="text-xs text-gray-800 text-gray-200 whitespace-pre-wrap">
{`{
  "mcpServers": {
    "task-master-ai": {
      "command": "npx",
        ...
        "PERPLEXITY_API_KEY": "your_perplexity_key_here"
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <a
                      ...
                      className="text-blue-600 text-blue-400 hover:text-blue-700 hover:text-blue-300 flex items-center gap-1"
                    >
            ...
            <div className="bg-gray-50 bg-gray-800 rounded-lg p-4">
              <h4 className="font-medium text-gray-900 text-white mb-2">Current Status</h4>
              <div className="flex items-center gap-2">
                {setupData.mcpConfigured ? (
                  <>
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    <span className="text-sm text-green-700 text-green-300">MCP server is configured</span>
                  </>
                ) : (
                  <>
                    <AlertCircle className="w-4 h-4 text-amber-500" />
                    <span className="text-sm text-amber-700 text-amber-300">MCP server not detected (optional)</span>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={12}
                  className="w-full px-3 py-2 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white bg-gray-800 text-gray-900 text-white font-mono text-sm"
...
- Phase 2: Enhancements"
              ...
              <div className="bg-blue-50 bg-blue-950 border border-blue-200 border-blue-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <Sparkles className="w-5 h-5 text-blue-600 text-blue-400 mt-0.5" />
                  <div>
                    <h4 className="font-medium text-blue-900 text-blue-100 mb-1">
                      AI Task Generation
                    </h4>
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <div className="bg-green-50 bg-green-950 border border-green-200 border-green-800 rounded-lg p-4">
              <h4 className="font-medium text-green-900 text-green-100 mb-3">
                Setup Summary
              </h4>
              <ul className="space-y-2 text-sm text-green-800 text-green-200">
            ...
            <div className="bg-blue-50 bg-blue-950 border border-blue-200 border-blue-800 rounded-lg p-4">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-blue-800 text-blue-200">
  ...
  return (
    <div className="modal-backdrop fixed inset-0 flex items-center justify-center z-[100] md:p-4 bg-black/50">
      <div className={cn(
        ...
        {/* Progress Bar */}
        <div className="px-4 md:px-6 py-4 border-b border-gray-200 border-gray-700">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6">
          ...
          {error && (
            <div className="mt-4 bg-red-50 bg-red-950 border border-red-200 border-red-800 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-red-600 text-red-400 mt-0.5" />
                <div>
                  <h4 className="font-medium text-red-900 text-red-100 mb-1">Error</h4>
        ...
        <div className="flex items-center justify-between p-4 md:p-6 border-t border-gray-200 border-gray-700 flex-shrink-0">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-gray-700 text-gray-300 bg-gray-100 bg-gray-800 hover:bg-gray-200 hover:bg-gray-700 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
