...
function LoginModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] max-md:items-stretch max-md:justify-stretch">
      <div className="bg-white bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl h-3/4 flex flex-col md:max-w-4xl md:h-3/4 md:rounded-lg md:m-4 max-md:max-w-none max-md:h-full max-md:rounded-none max-md:m-0">
        ...
        <div className="flex-1 overflow-hidden">
          {provider === 'gemini' ? (
            <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-gray-50 bg-gray-900/50">
              <div className="w-16 h-16 bg-blue-100 bg-blue-900/30 rounded-full flex items-center justify-center mb-6">
                <KeyRound className="w-8 h-8 text-blue-600 text-blue-400" />
              </div>

              <h4 className="text-xl font-medium text-gray-900 text-white mb-3">
                Setup Gemini API Access
              </h4>

              <p className="text-gray-600 text-gray-400 max-w-md mb-8">
              ...
              <div className="bg-white bg-gray-800 border border-gray-200 border-gray-700 rounded-xl p-6 max-w-lg w-full text-left shadow-sm">
                <ol className="space-y-4">
                  <li className="flex gap-4">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 bg-blue-900/50 text-blue-600 text-blue-400 flex items-center justify-center text-sm font-medium">
                      1
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-900 text-white mb-1">Get your API Key</p>
                      <a
                        href="https://aistudio.google.com/app/apikey"
                        target="_blank"
                        rel="noreferrer"
                        className="text-sm text-blue-600 text-blue-400 hover:underline flex items-center gap-1 inline-flex"
                      >
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900 text-white mb-1">Run configuration</p>
                      <p className="text-sm text-gray-600 text-gray-400 mb-2">Open your terminal and run:</p>
                      <code className="block bg-gray-100 bg-gray-900 px-3 py-2 rounded text-sm text-pink-600 text-pink-400 font-mono">
