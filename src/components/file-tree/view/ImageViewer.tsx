...
export default function ImageViewer({ file, onClose }: ImageViewerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white bg-gray-800 rounded-lg shadow-xl max-w-4xl max-h-[90vh] w-full mx-4 overflow-hidden">
        ...
        <div className="p-4 flex justify-center items-center bg-gray-50 bg-gray-900 min-h-[400px]">
          {loading && (
        ...
        <div className="p-4 border-t bg-gray-50 bg-gray-800">
