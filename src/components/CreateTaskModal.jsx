      ...
      <div className="bg-white bg-gray-800 rounded-lg shadow-xl w-full max-w-md border border-gray-200 border-gray-700">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900 text-white">Create AI-Generated Task</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 bg-blue-900/20 rounded-lg p-4 border border-blue-200 border-blue-800">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-blue-100 bg-blue-900/50 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                <Sparkles className="w-4 h-4 text-blue-600 text-blue-400" />
              </div>
              <div className="flex-1">
                <h4 className="font-semibold text-blue-900 text-blue-100 mb-2">
                ...
                <div className="bg-white bg-gray-800 rounded border border-blue-200 border-blue-700 p-3 mb-3">
                  <p className="text-xs font-medium text-gray-600 text-gray-400 mb-1">Example:</p>
                  <p className="text-sm text-gray-900 text-white font-mono">
                    "Please add a new task to implement user profile image uploads using Cloudinary, research the best approach."
                  </p>
                </div>
                
                <p className="text-xs text-blue-700 text-blue-300">
                  <strong>This runs:</strong> <code className="bg-blue-100 bg-blue-900/50 px-1 rounded text-xs">
          ...
          <div className="text-center pt-4 border-t border-gray-200 border-gray-700">
            ...
            <a
              ...
              className="inline-block text-sm text-blue-600 text-blue-400 hover:text-blue-700 hover:text-blue-300 underline font-medium"
            >
