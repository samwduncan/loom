  ...
  return (
    <div className="space-y-8">
      {isCheckingInstallation ? (
        ...
        <>
          {!isTaskMasterInstalled && (
            <div className="bg-orange-50 bg-orange-950/50 border border-orange-200 border-orange-800 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-orange-100 bg-orange-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4 text-orange-600 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="text-sm text-orange-800 text-orange-200 space-y-3">
                    ...
                    <div>
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-blue-600 text-blue-400 hover:text-blue-700 hover:text-blue-300 font-medium text-sm"
                      >
