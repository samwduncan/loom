              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-orange-200 space-y-3">
                    ...
                    <div className="bg-orange-900/50 rounded-lg p-3 font-mono text-sm">
                    ...
                    <div>
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-status-info hover:text-status-info/80 font-medium text-sm"
                      >
